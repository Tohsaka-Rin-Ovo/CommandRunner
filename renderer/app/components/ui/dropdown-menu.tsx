...
>(({ ...props }, forwardedRef) => {
  return <DropdownMenuPrimitive.Root ref={forwardedRef} data-slot="dropdown-menu" {...props} />;
});
...
>(({ ...props }, forwardedRef) => {
  return (
    <DropdownMenuPrimitive.Portal ref={forwardedRef} data-slot="dropdown-menu-portal" {...props} />
  );
});
...
>(({ ...props }, forwardedRef) => {
  return (
    <DropdownMenuPrimitive.Group ref={forwardedRef} data-slot="dropdown-menu-group" {...props} />
  );
});
...
>(({ className, inset, variant = "default", ...props }, forwardedRef) => {
  return (
...
>(({ ...props }, forwardedRef) => {
  return (
    <DropdownMenuPrimitive.RadioGroup ref={forwardedRef} data-slot="dropdown-menu-radio-group" {...props} />
  );
});
...
>(({ ...props }, forwardedRef) => {
  return <DropdownMenuPrimitive.Sub ref={forwardedRef} data-slot="dropdown-menu-sub" {...props} />;
});
